...
class Life_Settings {
	...
	"storageBig", "redgull", "coffee", "waterBottle", "apple", "peach", "tbacon", "donut", "rabbitGrilled", "salemaGrilled", 
	"ornateGrilled", "mackerelGrilled", "tunaGrilled", "mulletGrilled", "catsharkGrilled", "turtleSoup", "henGrilled", "roosterGrilled", 
	"sheepGrilled", "goatGrilled", "rabbitRaw", "salemaRaw", "ornateRaw", "mackerelRaw", "tunaRaw", "mulletRaw", "catsharkRaw", "turtleRaw", "henRaw", "roosterRaw", 
	"sheepRaw", "goatRaw", "goldbar", "blastingCharge", "boltCutter", "defuseKit", "oilUnprocessed", "oilProcessed", "copperUnrefined", "copperRefined",
	"ironUnrefined", "ironRefined", "saltUnrefined", "saltRefined", "sand", "glass", "diamondUncut", "diamondCut",  "rock", "cement", "heroinUnprocessed",
	"heroinProcessed", "cannabis", "marijuana", "cocaineUnprocessed", "cocaineProcessed" , "mushrooms", "cigarette"};
};
...
class VirtualItems {
	...
	VITEMMACRO(defusekit, "STR_Item_DefuseKit", "defuseKit", 2, 2500, -1, false, -1, "icons\defuse.paa")
	...
	VITEMMACRO(cigarette, "STR_Item_Cigarette","cigarette",1,200,-1,false,-1,"")

	//Mined Items
	VITEMMACRO(oil_unprocessed, "STR_Item_OilU", "oilUnprocessed", 7, -1, -1, false, -1, "")
	VITEMMACRO(oil_processed, "STR_Item_OilP", "oilProcessed", 6, -1, 4000, false, -1, "")
	...
	VITEMMACRO(diamond_cut, "STR_Item_DiamondC", "diamondCut", 2, -1, 3000, false, -1, "")
	VITEMMACRO(rock, "STR_Item_Rock", "rock", 6, -1, -1, false, -1, "")
	VITEMMACRO(cement, "STR_Item_CementBag", "cement", 5, -1, 1950, false, -1, "")

	//Drugs
	VITEMMACRO(heroin_unprocessed, "STR_Item_HeroinU", "heroinUnprocessed", 6, -1, -1, true, -1, "icons\heroinu.paa")
	VITEMMACRO(heroin_processed, "STR_Item_HeroinP", "heroinProcessed", 4, -1, 2560, true, -1, "icons\heroinp.paa")
	...
	VITEMMACRO(cocaine_unprocessed, "STR_Item_CocaineU", "cocaineUnprocessed", 6, -1, 3000, true, -1, "icons\cocaineu.paa")
	VITEMMACRO(cocaine_processed, "STR_Item_CocaineP", "cocaineProcessed", 4, -1, 5000, true, -1, "icons\cocainep.paa")
	VITEMMACRO(mushrooms, "STR_Item_Mushrooms", "mushrooms", 2, 2000, 1600, true, -1, "")
	...
	VITEMMACRO(rabbit_raw, "STR_Item_Rabbit", "rabbitRaw", 2, -1, 65, false, -1, "icons\raw.paa")
	VITEMMACRO(rabbit_grilled, "STR_Item_RabbitGrilled", "rabbitGrilled", 1, 150, 115, false, 20, "icons\ico_cookedMeat.paa")
	VITEMMACRO(salema_raw, "STR_Item_Salema", "salemaRaw", 2, -1, 450, false, -1, "icons\food.paa")
	VITEMMACRO(salema_grilled, "STR_Item_SalemaGrilled", "salemaGrilled", 1, 750, 550, false, 30, "icons\ico_cookedMeat.paa")
	VITEMMACRO(ornate_raw, "STR_Item_OrnateMeat", "ornateRaw", 2, -1, 400, false, -1, "icons\ornate.paa")
	VITEMMACRO(ornate_grilled, "STR_Item_OrnateGrilled", "ornateGrilled", 1, 1750, 1500, false, 25, "icons\ornate.paa")
	VITEMMACRO(mackerel_raw, "STR_Item_MackerelMeat", "mackerelRaw", 4, -1, 1750, false, -1, "icons\mackerel.paa")
	VITEMMACRO(mackerel_grilled, "STR_Item_MackerelGrilled", "mackerelGrilled", 2, 1500, 1000, false, 30, "icons\mackerel.paa")
	VITEMMACRO(tuna_raw, "STR_Item_TunaMeat", "tunaRaw", 6, -1, 1000, false, -1, "icons\tuna.paa")
	VITEMMACRO(tuna_grilled, "STR_Item_TunaGrilled", "tunaGrilled", 3, 1250, 1000, false, 100, "icons\tuna.paa")
	VITEMMACRO(mullet_raw, "STR_Item_MulletMeat", "mulletRaw", 4, -1, 1500, false, -1, "icons\mullet.paa")
	VITEMMACRO(mullet_fried, "STR_Item_MulletFried", "mulletFried", 2, 2000, 1000, false, 80, "icons\mullet.paa")
	VITEMMACRO(catshark_raw, "STR_Item_CatSharkMeat", "catsharkRaw", 6, -1, 1000, false, -1, "icons\shark.paa")
	VITEMMACRO(catshark_fried, "STR_Item_CatSharkFried", "catsharkFried", 3, 1000, 500, false, 100, "icons\shark.paa")
	VITEMMACRO(turtle_raw, "STR_Item_TurtleMeat", "turtleRaw", 6, 1000, 500, true, -1, "icons\turtle.paa")
	VITEMMACRO(turtle_soup, "STR_Item_TurtleSoup", "turtleSoup", 2, 1000, 500, false, 100, "icons\soup.paa")
	VITEMMACRO(hen_raw, "STR_Item_HenRaw", "henRaw", 1, -1, 350, false, -1, "icons\raw.paa")
	VITEMMACRO(hen_fried, "STR_Item_HenFried", "henFried", 1, 1150, 850, false, 65, "icons\ico_cookedMeat.paa")
	VITEMMACRO(rooster_raw, "STR_Item_RoosterRaw", "roosterRaw", 1, -1, 350, false, -1, "icons\raw.paa")
	VITEMMACRO(rooster_grilled, "STR_Item_RoosterGrilled", "roosterGrilled", 1150, 850, false, 45, "icons\ico_cookedMeat.paa")
	VITEMMACRO(sheep_raw, "STR_Item_SheepRaw", "sheepRaw", 2, -1, 500, false, -1, "icons\raw.paa")
	VITEMMACRO(sheep_grilled, "STR_Item_SheepGrilled", "sheepGrilled", 2, 1550, 1150, false, 100, "icons\ico_cookedMeat.paa")
	VITEMMACRO(goat_raw, "STR_Item_GoatRaw", "goatRaw", 2, -1, 750, false, -1, "icons\raw.paa")
	VITEMMACRO(goat_grilled, "STR_Item_GoatGrilled", "goatGrilled", 2, 1750, 1350, false, 100, "icons\ico_cookedMeat.paa")
};
...
class Licenses {
	...
	LICENSEMACRO(hunt,"STR_License_Hunt","hunt",15000,false,"civ")
};

class VirtualShops {
	class market {
		name = "STR_Shops_Market";
		items[] = { "waterBottle", "rabbit_grilled", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "fuelFull", "peach", "boltcutter", "storagesmall", "storagebig", "cigarette" };
	};
	...
	class drugdealer {
		...
		items[] = { "cocaine_processed", "heroin_processed", "marijuana" , "mushrooms" };
	};

	class oil {
		name = "STR_Shops_Oil";
		items[] = { "oil_processed", "pickaxe", "fuelFull", "earplugs" };
	};
