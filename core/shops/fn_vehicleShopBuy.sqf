...
if (_vehicle in ["B_UAV_02_F","B_UAV_01_F"]) then {
...
if(_mode) then {
	if(!(_className in ["B_G_Offroad_01_armed_F","B_MRAP_01_hmg_F", "ACR_Offroad_HMG", "BAF_Offroad_W_HMG", "LandRover_MG_TK_EP1", "B_Heli_Light_01_armed_F", "AH64D", "rhs_t80b", "rhsusf_m1a1aim_tuski_d"])) then {
