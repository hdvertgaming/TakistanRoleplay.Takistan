...
_Btn8 ctrlSetText localize "DISARM";
_Btn8 buttonSetAction "removeAllWeapons life_pInact_curTarget;";

//Check that you are near a place to jail them.
if(!((player distance (getMarkerPos "cop_spawn_1") < 30) OR (player distance (getMarkerPos "cop_spawn_2") < 30) OR (player distance (getMarkerPos "jail_marker") < 50))) then  {
