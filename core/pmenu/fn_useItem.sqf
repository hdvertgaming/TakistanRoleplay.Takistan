...
switch (true) do {
	...
	case (_item in ["apple","rabbit_grilled","salema_grilled","ornate_grilled","mackerel_grilled","tuna_grilled","mullet_grilled","catshark_grilled","turtle_soup","donut","tbacon","peach"]): {
